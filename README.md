...
| **T1537** | S3 Bucket Made Public | CloudTrail: PutBucketPolicy (Principal: "*") | High | ✅ Engineered | [View Scenario](./detection-scenarios/scenario12-T1537-s3-public-bucket/README.md) |
---
...
│   ├── T1547.001-run-key-persistence.ndjson
